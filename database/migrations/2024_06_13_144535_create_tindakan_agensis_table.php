...
return new class extends Migration
{
    ...
    {
        Schema::create('tindakan_agensis', function (Blueprint $table) {
            $table->id();
            ...
            $table->string('action_application_role');
            $table->string('action_application_agensi_name')->default('Putrakop');
            $table->timestamps();
        });
    }
    ...
    {
        Schema::dropIfExists('tindakan_agensis');
    }
};
