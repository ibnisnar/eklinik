...
return new class extends Migration
{
    ...
    {
        Schema::create('keterangan_penambahans', function (Blueprint $table) {
            $table->id();
            $table->unsignedBigInteger('fk_application')->nullable();
            $table->foreign('fk_application')->references('id')->on('permohonan_penambahans')->onDelete('cascade');
    ...
    {
        Schema::dropIfExists('keterangan_penambahans');
    }
};
