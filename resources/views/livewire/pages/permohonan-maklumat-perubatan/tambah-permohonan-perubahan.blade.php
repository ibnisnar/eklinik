<x-slot name="header">
    <h2 class="font-semibold text-xl text-gray-800 dark:text-gray-200 leading-tight">
        {{ __('Permohonan Perubahan Maklumat Perubatan') }}
    </h2>
</x-slot>
            ...
            <div class="p-6 text-gray-900 dark:text-gray-100">
                ...
                <form wire:submit.prevent="createPermohonanMaklumatPerubatan" class="p-4 md:p-5" >
                    ...
                    <div class="grid gap-4 mb-4 grid-cols-3">
                        ...
                        <div class="col-span-2 sm:col-span-1">
                            <label for="permohonan_fk_user_display" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Klinik</label>
                    ...
                    <div class="text-right">
                        <a href="{{ route('senarai-permohonan-perubahan-maklumat-perubatan.index') }}" class="inline-flex py-2.5 px-5 me-2 mb-2 text-sm font-medium text-gray-900 focus:outline-none bg-white rounded-lg border border-gray-200 hover:bg-gray-100 hover:text-blue-700 focus:z-10 focus:ring-4 focus:ring-gray-100 dark:focus:ring-gray-700 dark:bg-gray-800 dark:text-gray-400 dark:border-gray-600 dark:hover:text-white dark:hover:bg-gray-700">
