<x-app-layout>
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            @if($permohonan)
                @php
                    $permohonan = App\Models\PermohonanPenambahan::where('application_no', $permohonan)->first();
                @endphp
                <x-slot name="header">
                    <li>
                      <div class="flex items-center">
                        ...
                        <a href="{{ route('senarai-permohonan-penambahan') }}" class="ms-1 text-sm font-medium text-gray-700 hover:text-blue-600 md:ms-2 dark:text-gray-400 dark:hover:text-white">Pengurusan Permohonan Perubatan</a>
                      </div>
                    </li>
                ...
                <div class="w-full p-4 bg-white border border-gray-200 rounded-lg shadow sm:p-8 dark:bg-gray-800 dark:border-gray-700">
                    <div class="flex items-center justify-between mb-4">
                        <h5 class="text-md font-medium leading-none text-gray-900 dark:text-white">Maklumat Permohonan Penambahan</h5>
                    </div>
                    <div class="flow-root">
                                    ...
                                    <tr class="text-center odd:bg-white odd:dark:bg-gray-900 even:bg-gray-50 even:dark:bg-gray-800 border-b dark:border-gray-700">
                                        <td colspan="5" class="p-5 text-left">
                                            ...
                                            <div class="mt-6 flex justify-end">
                                                <a href="{{ route('senarai-permohonan-penambahan') }}" class="inline-flex items-center px-4 py-2 bg-white dark:bg-gray-800 border border-gray-300 dark:border-gray-500 rounded-md font-semibold text-xs text-gray-700 dark:text-gray-300 uppercase tracking-widest shadow-sm hover:bg-gray-50 dark:hover:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 dark:focus:ring-offset-gray-800 disabled:opacity-25 transition ease-in-out duration-150">
                                                    {{ __('Kembali') }}
                                                </a>
                                            </div>
                                        </td>
                ...
                <div class="w-full p-4 bg-white border border-gray-200 rounded-lg shadow sm:p-8 dark:bg-gray-800 dark:border-gray-700">
                    <div class="flex items-center justify-between mb-4">
                        ...
                        <div class="flex gap-2"> 
                            <form class="flex items-center" action="{{ route('senarai-permohonan-penambahan') }}" method="GET">   
                                ...
                                <div class="relative w-full">
                                    ...
                                    @if(request()->has('carian'))
                                        <a href="{{ route('senarai-permohonan-penambahan') }}" class="absolute inset-y-0 end-0 flex items-center pe-3">
                            ...
                            <button x-data="" x-on:click.prevent="$dispatch('open-modal', 'tambah-permohonan-penambahan')" type="button" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-3 py-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">Permohonan Penambahan</button>
                            <x-modal name="tambah-permohonan-penambahan" focusable maxWidth="6xl">
                                @php
                                ...
                                @endphp
                                <form method="post" action="{{ route('store.permohonan-penambahan') }}" class="p-6">
                                    @csrf
                                    ...
                                    <h2 class="text-lg mb-6 font-medium text-gray-900 dark:text-gray-100">
                                        {{ __('Maklumat Permohonan Penambahan Maklumat Rawatan') }}
                                    </h2>
